...
var login = exports.login = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(email, password) {
    var _res$data, res, _error$response$data$, _error$response, _t;
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        ...
        case 3:
          _context.p = 3;
          _t = _context.v;
          (0, _alerts.showAlert)("error", (_error$response$data$ = _t === null || _t === void 0 || (_error$response = _t.response) === null || _error$response === void 0 ? void 0 : _error$response.data.message) !== null && _error$response$data$ !== void 0 ? _error$response$data$ : "Error while logging user");
        case 4:
          return _context.a(2);
      }
    }, _callee, null, [[1, 3]]);
    ...
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.p = _context2.n) {
        ...
        case 2:
          _context2.p = 2;
          _t2 = _context2.v;
          console.log("error while logging out>>", _t2);
...
var updateSettings = exports.updateSettings = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(data, type) {
    var url, _res$data, res, _error$response$data$, _error$response, _t;
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        case 0:
        ...
        case 2:
          res = _context.v;
          if ((res === null || res === void 0 || (_res$data = res.data) === null || _res$data === void 0 ? void 0 : _res$data.status) === 'success') {
            (0, _alerts.showAlert)('success', "".concat(type === null || type === void 0 ? void 0 : type.toUpperCase(), " ppdated successfull!"));
          }
          _context.n = 4;
          break;
        case 3:
          _context.p = 3;
          _t = _context.v;
          (0, _alerts.showAlert)("error", (_error$response$data$ = _t === null || _t === void 0 || (_error$response = _t.response) === null || _error$response === void 0 ? void 0 : _error$response.data.message) !== null && _error$response$data$ !== void 0 ? _error$response$data$ : "Error while updating!");
          window.setTimeout(function () {
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; }
var stripe = Stripe("pk_test_51QM0iZSAQ6TXBx5vMZJXB4LwUZBnZdZzPWz1s3DQR6JBa50zIhk5fRFn0D9MBZqvrQdHqW3LHNJmwhyw5pAC5jVS00M6uGFQZx");
